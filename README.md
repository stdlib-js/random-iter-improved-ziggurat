...
```javascript
import iterator from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-iter-improved-ziggurat@v0.2.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/random-iter-improved-ziggurat/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/random-iter-improved-ziggurat/actions/workflows/test.yml?query=branch:v0.2.2
